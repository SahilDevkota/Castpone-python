...
def grabTheListOfData(list_of_data: list[DataModel]):
    ...
    total_length = len(list_for_lstm) - sequence_length - prediction_length + 1

    if total_length < 2:
        raise ValueError("Need at least 36 records")
    ...
    for i in range(total_length):
        ...
        prediction_array = list_for_lstm[
            i + sequence_length:
